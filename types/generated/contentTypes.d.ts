...
export interface ApiCarCar extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    bags: Schema.Attribute.Integer;
    bluetooth: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    brand: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    gear_shift: Schema.Attribute.Enumeration<['Automatic', 'Manual']> &
    ...
    passengers: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1>;
...
export interface ApiCustomerCustomer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    driver_age: Schema.Attribute.Enumeration<
      ['age_21_25', 'age_26_85', 'age_86_and_over']
    >;
    email: Schema.Attribute.Email;
...
export interface ApiReservationReservation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    dropoff_date: Schema.Attribute.Date &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'2025-06-19'>;
    dropoff_time: Schema.Attribute.Time &
    ...
    status_r: Schema.Attribute.Enumeration<
